            ...
            <div className="navbar-right">
                ...
                <div style={{ position: 'relative' }} ref={notificationRef}>
                    <button type="button" onClick={(e) => { e.preventDefault(); setShowNotifications(!showNotifications); }} style={{ position: 'relative' }}>
                        ...
                        {hasUnread && (
                            <>
                                <span style={{ position: 'absolute', top: '4px', right: '4px', width: '8px', height: '8px', background: '#ef4444', borderRadius: '50%', border: '2px solid white', zIndex: 2 }}></span>
                                <span className="ping-animation" style={{ position: 'absolute', top: '4px', right: '4px', width: '8px', height: '8px', background: '#ef4444', borderRadius: '50%', zIndex: 1 }}></span>
                            </>
                        )}
                    </button>
