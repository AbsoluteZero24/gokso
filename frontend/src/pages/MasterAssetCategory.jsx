                ...
                <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, backdropFilter: 'blur(4px)' }}>
                    <div className="chart-container" style={{ width: '100%', maxWidth: '450px', margin: '1rem', position: 'relative' }}>
                        <div style={{ marginBottom: '1.5rem' }}>
                            <h2 style={{ fontSize: '1.25rem', fontWeight: 800 }}>{editingCategory ? 'Edit Kategori' : 'Tambah Kategori'}</h2>
                            <p style={{ color: 'var(--text-light)', fontSize: '0.875rem' }}>Masukkan nama kategori aset baru</p>
                        </div>

                        <form onSubmit={handleSubmit}>
                            <div style={{ marginBottom: '1.5rem' }}>
                                <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 600, marginBottom: '0.5rem', color: '#64748b' }}>Nama Kategori</label>
                                <input
                                    type="text"
                                    required
                                    className="search-input"
