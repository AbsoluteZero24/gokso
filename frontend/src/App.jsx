...
import Aset from './pages/inventory/Aset';
import Service from './pages/inventory/Service';
...
import GoForm from './pages/forms/GoForm';
import GoSign from './pages/forms/GoSign';
import MasterBranch from './pages/admin/MasterBranch';
import MasterDepartment from './pages/admin/MasterDepartment';
import MasterPosition from './pages/admin/MasterPosition';
import MasterAssetCategory from './pages/admin/MasterAssetCategory';
import FormBASTLaptop from './pages/forms/FormBASTLaptop';
